...
public class TelaCarregamento extends JFrame {
	...
	public TelaCarregamento() {
		...
		panel.setBounds(0, 0, 434, 376);
		contentPane.add(panel);
		panel.setLayout(null);
		
	    texto = new JLabel(".");
		texto.setBounds(24, 11, 46, 14);
		panel.add(texto);
		
		percent = new JLabel(".");
		percent.setBounds(353, 11, 46, 14);
		panel.add(percent);
	
		barra = new JProgressBar();
		barra.setForeground(Color.GREEN);
		barra.setBounds(80, 313, 270, 35);
		panel.add(barra);
	...
	* da progressive Bar */
	...
	Pergunta_1 tela= new Pergunta_1();//constroi a tela//
